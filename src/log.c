...
static const char *LEVEL_COLORS[] = {[LOG_INFO] = "\x1b[32m",
                                     [LOG_WARN] = "\x1b[33m",
                                     [LOG_ERROR] = "\x1b[31m",
                                     [LOG_DEBUG] = "\x1b[36m"};

static const char *THREAD_COLORS[] = {
    [LOG_COLOR_DEFAULT] = "\x1b[0m", [LOG_COLOR_RED] = "\x1b[31m",
    [LOG_COLOR_GREEN] = "\x1b[32m",  [LOG_COLOR_YELLOW] = "\x1b[33m",
    [LOG_COLOR_BLUE] = "\x1b[34m",   [LOG_COLOR_MAGENTA] = "\x1b[35m",
    [LOG_COLOR_CYAN] = "\x1b[36m",   [LOG_COLOR_WHITE] = "\x1b[37m"};
...
void log_msg(enum LogLevel level, const char *fmt, ...) {
  ...
  fprintf(stderr, "%s[%s]%s %s[%s]%s ", LEVEL_COLORS[level], level_str, reset,
