 ...
 *
 * This file defines the high-level functions that may called by the application
 * frontend, to set up the P2P client and interact with it
 *
 */
 ...
 * @return int 0 if the file was downloaded successfully, a negative number
 * otherwise
 */
