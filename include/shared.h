...
/**
 * @brief Represents a single ID in the network, this may represent a user or file id, or a distance between any thereof
 * 
 */
...
/**
 * @brief Checks for NULL pointers when allocating memory, and exits the client if allocation failed
 * 
 ...
 * @return int Returns 0 if the hash was computed successfully, a negative number otherwise
 */
 ...
 * 
 * @param in_buf A buffer containing the contents for which a SHA-256 sum should be computed
 ...
 * 
 * @param ip_buf A buffer to store the string representation of the client IP, it should be at least INET_ADDRSTRLEN bytes long
 * @param buf_size The size of the buffer to store the string representation
 * @param out_addr May be NULL, if present, a copy of struct sockaddr_in contents will be copied into it
 * @return int Returns 0 if the primary IP was obtained successfully, a negative number otherwise
 */
 ...
 * 
 * @param out A pointer to memory where the network ID of the client should be stored
 * @return int Returns 0 if the ID was obtained successfully, a negative number otherwise
 */
 ...
 * 
 * @param out_peer A pointer to memory where the peer information should be stored
 * @return int Returns 0 if the client information was obtained successfully, a negative number otherwise
 */
